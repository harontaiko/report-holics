<div class="content-wrapper">
    ...
    <div class="confirm">
        ...
        <input type="hidden" id="date-" value="<?php echo isset($data['date']) ? $data['date']: ''; ?>">
    ...
    <div id="open-modal" class="modal-window">
        <div class="card bg-warning m-4">
            ...
            <form>
                ...
                <input required type="password" id="password" class="form-control mb-2 mr-sm-2"
                    id="inlineFormInputName2" placeholder="password">
