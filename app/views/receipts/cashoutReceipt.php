...
<div class="betslip-container" id="betslip-container">
    <div class="betslip-header-container">
        <div class="betslip-type-container">
            ...
            <span class="betslip-odds"><?php print_r($arr['5']); ?></span>
        </div>
    </div>
    ...
    <div class="betslip-pick-container">
        <div class="betslip-pick">
            ...
            <div class="pick-details">
                <span>Taken From: <?php print_r($arr['3']); ?></span><br />
            </div>
            <div class="pick-odds"><?php print_r(number_format($arr['1'])); ?>/=</div>
        </div>
        <div class="betslip-pick">
            <div class="pick-dismiss">
                <i class="fa fa-check-circle"></i>
            ...
            <div class="pick-details">
                <span>Usage: <?php print_r(number_format($arr['1'])); ?></span><br />
            </div>
        ...
        <div class="betslip-pick">
            ...
            <div class="pick-details">
                <span>By: <?php print_r($arr['4']); ?></span><br />
            </div>
            <div class="pick-odds">N/A</div>
        </div>
    </div>
    ...
    <div class="betslip-accumulators">
        ...
        <div class="accumulator-amount">
            <input value="<?php print_r(number_format($arr['1'])); ?>/=" readonly />
        </div>
    </div>
    <div>
    </div>
